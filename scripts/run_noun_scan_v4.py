#!/usr/bin/env python
"""Run noun steganography experiment v4: indirect priming with quoted codewords, CAPS eval."""
import argparse
import asyncio
import sys
...
sys.path.insert(0, str(__file__).replace("/scripts/run_noun_scan_v4.py", "/src"))

from codeword_sort.client import SortClient
from codeword_sort.noun_scan_v4 import (
...
def main():
    parser = argparse.ArgumentParser(description="Noun steganography v4")
    ...
    logger.info(f"Noun scan v4: {n_groups} groups, {n_models} models")

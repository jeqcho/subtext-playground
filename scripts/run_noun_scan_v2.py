#!/usr/bin/env python
"""Run noun steganography experiment v2: explicit game prompt, CAPS words."""
import argparse
import asyncio
import sys
...
sys.path.insert(0, str(__file__).replace("/scripts/run_noun_scan_v2.py", "/src"))

from codeword_sort.client import SortClient
from codeword_sort.noun_scan_v2 import (
...
def main():
    parser = argparse.ArgumentParser(description="Noun steganography v2")
    ...
    logger.info(f"Noun scan v2: {n_groups} groups, {n_models} models")

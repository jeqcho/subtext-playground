#!/usr/bin/env python
"""Run noun steganography experiment v3: indirect priming with CAPS codewords."""
import argparse
import asyncio
import sys
...
sys.path.insert(0, str(__file__).replace("/scripts/run_noun_scan_v3.py", "/src"))

from codeword_sort.client import SortClient
from codeword_sort.noun_scan_v3 import (
...
def main():
    parser = argparse.ArgumentParser(description="Noun steganography v3")
    ...
    logger.info(f"Noun scan v3: {n_groups} groups, {n_models} models")
